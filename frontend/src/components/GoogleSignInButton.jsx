const GoogleSignInButton = () => {
  ...
  const googleStartUrl = `${apiBase.replace(/\/$/, "")}/users/google`;

  return (
    <div className="flex flex-col items-center gap-2 w-full">
      <a
        href={googleStartUrl}
        className="inline-flex items-center justify-center gap-3 w-full max-w-xs bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium px-4 py-2.5 rounded-lg shadow-sm transition"
      >
        <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
          ...
          <path
            fill="#4CAF50"
            d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.3 35.1 26.8 36 24 36c-5.3 0-9.7-3.1-11.3-7.5l-6.5 5C9.1 39.5 16 44 24 44z"
          />
          <path
            fill="#1976D2"
