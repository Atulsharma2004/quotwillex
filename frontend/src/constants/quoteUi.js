...
const UI = {
  english: {
    ...
    postingQuote: "Posting…",
    postSuccess: "Quote posted successfully!",
    ...
    publishingQuote: "Publishing…",
    publishSuccess: "Popular quote published successfully!",
    bulkUploadTitle: "Bulk upload popular quotes",
    bulkUploadHint:
      "Upload a JSON file with up to 30 quotes. Required: language, quote, writer. Optional: source, category. If category is \"other\", set \"other\" to your custom category.",
    bulkUploadButton: "Upload JSON",
    bulkUploading: "Uploading…",
    bulkChooseFile: "Choose JSON file",
    bulkDownloadSample: "Download sample JSON",
  ...
  hindi: {
    ...
    postingQuote: "पोस्ट हो रहा है…",
    postSuccess: "क्वोट सफलतापूर्वक पोस्ट हो गया!",
    ...
    publishingQuote: "पब्लिश हो रहा है…",
    publishSuccess: "पॉपुलर क्वोट सफलतापूर्वक पब्लिश हो गया!",
    bulkUploadTitle: "पॉपुलर क्वोट्स बल्क अपलोड",
    bulkUploadHint:
      "JSON फ़ाइल में अधिकतम 30 क्वोट्स अपलोड करें। ज़रूरी: language, quote, writer। वैकल्पिक: source, category। अगर category \"other\" है तो \"other\" में अपनी कस्टम श्रेणी लिखें।",
    bulkUploadButton: "JSON अपलोड करें",
    bulkUploading: "अपलोड हो रहा है…",
    bulkChooseFile: "JSON फ़ाइल चुनें",
    bulkDownloadSample: "सैंपल JSON डाउनलोड करें",
    postingComment: "पोस्ट हो रहा है…",
    commentSuccess: "कमेंट सफलतापूर्वक पोस्ट हो गया!",
